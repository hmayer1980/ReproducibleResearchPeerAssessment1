...
The **Mean** of the tidy(NAs removed) dataset is **`r MeanOfStepsPerDay`**.  
The **Median** of the tidy(NAs removed) dataset is **`r MedianOfStepsPerDay`**.
...
The interval **`r MaxIntervalNumber`** with an average of **`r MaxIntervalValue`** was the hightest.
...
1.The total number of NA values in the steps (the only column with NA values) is **`r NumberOfNaValues`**.
...
The **Mean** of the NA substituted dataset is **`r MeanOfStepsPerDayFull`**.  
The **Median** of the NA substituted dataset is **`r MedianOfStepsPerDayFull`**.
